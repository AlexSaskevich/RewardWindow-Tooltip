...
using Code.UI.RewardWindowLogic;
using UnityEngine;
...
namespace Code.UI
{
    public class MainWindow : BaseWindow
    {
        ...
        {
            _button1.onClick.RemoveListener(Inventory1);
            _button2.onClick.RemoveListener(Inventory2);
        }
...
и так далее"
        ...
        {
            RewardWindowArgs rewardWindowArgs = new("Reward 1", new List<InventoryItem>
            {
        ...
        {
            RewardWindowArgs rewardWindowArgs = new("Rewards From Other Place", new List<InventoryItem>
            {
                new(MakeTitle(1), MakeDesc(1), _icons[Random.Range(0, _icons.Length)]),
                new(MakeTitle(2), MakeDesc(2), _icons[Random.Range(0, _icons.Length)]),
                new(MakeTitle(3), MakeDesc(3), _icons[Random.Range(0, _icons.Length)]),
